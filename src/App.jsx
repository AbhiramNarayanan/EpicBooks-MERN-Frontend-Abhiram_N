...
//give the project name(thats the name coming to the folder) so i gave frontend, then selected framework as react and variant javascript
...
const App = () => {
  ...
  // <div className="bg-red-400 text-white">App</div>//use styles like these type placed inside className //in tailwind css we dont need an extra file 
                                                           //we can create css styles in the main file itself for eg in html itself or at js file in react
  ...
  //now for components make a folder called pages and then inside that create diff components are created and use them as our application base
